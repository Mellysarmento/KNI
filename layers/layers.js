...
ol.proj.get("EPSG:4326").setExtent([125.423965, -8.735627, 125.459398, -8.714372]);
var wms_layers = [];
...
var format_peskizaKNI_3 = new ol.format.GeoJSON();
var features_peskizaKNI_3 = format_peskizaKNI_3.readFeatures(json_peskizaKNI_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_peskizaKNI_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_peskizaKNI_3.addFeatures(features_peskizaKNI_3);
var lyr_peskizaKNI_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_peskizaKNI_3, 
                style: style_peskizaKNI_3,
                interactive: true,
                title: '<img src="styles/legend/peskizaKNI_3.png" /> peskiza KNI'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_BENEFISIARIUSKNI_2.setVisible(true);lyr_peskizaKNI_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_GoogleSatellite_1,lyr_BENEFISIARIUSKNI_2,lyr_peskizaKNI_3];
